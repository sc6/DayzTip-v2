...
<?php if($login->isUserLoggedIn() == true && $flag_switch == true): ?> 
	<div class="edit_button"><a href="../items/item_details/information_input.php?action=edit_warnings" id="small">[Add]</a></div>
<?php else: ?>
	<div class="edit_button"><span id="subtle">[Locked]</span></div>
<?php endif;?>


<span class="subtitle">Flags</span>
<br /><br />

<?php
//This file is meant to be an 'include'.
//	Provides the client with the item's warnings.
...
$query = "SELECT * FROM `comments` WHERE item='".$_SESSION['item']."' AND type='flag' ORDER BY points DESC";
