...
<?php if($login->isUserLoggedIn() == true && $HTG_switch == true): ?> 
	<div class="edit_button"><a href="../items/item_details/information_input.php?action=edit_HTG" id="small">[Add]</a></div>
<?php else: ?>
	<div class="edit_button"><span id="subtle">[Locked]</span></div>
<?php endif;?>

<span class="subtitle">How to obtain</span>
<br /><br />
...
$query = "SELECT * FROM `comments` WHERE item='".$_SESSION['item']."' AND type='HTG' ORDER BY points DESC";
