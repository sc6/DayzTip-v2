...
<?php if($login->isUserLoggedIn() == true && $uses_switch == true): ?> 
	<div class="edit_button"><a href="../items/item_details/information_input.php?action=edit_uses" id="small">[Add]</a></div>
<?php else: ?>
	<div class="edit_button"><span id="subtle">[Locked]</span></div>
<?php endif;?>


<span class="subtitle">Item uses</span>
<br /><br />

<?php
//This file is meant to be an 'include'.
//	Provides the client with the item's uses comments.
...
$query = "SELECT * FROM `comments` WHERE item='".$_SESSION['item']."' AND type='uses' ORDER BY points DESC";
