...
<?php if($login->isUserLoggedIn() == true && $dialogue_switch == true): ?> 
	<div class="edit_button"><a href="../items/item_details/information_input.php?action=edit_dialogue" id="small">[Add]</a></div>
<?php else: ?>
	<div class="edit_button"><span id="subtle">[Locked]</span></div>
<?php endif;?>


<span class="subtitle">Item dialogue</span>
<br /><br />
...
$query = "SELECT * FROM `comments` WHERE item='".$_SESSION['item']."' AND type='dialogue' ORDER BY points DESC";
...
while($row = mysqli_fetch_array($result, MYSQLI_ASSOC)) {
	...
	'<span class="dialogue">"'.
	$comment.
	'"</span> <span id="subtle"> ' . $author . ' (' . $author_level . ')</span>';
